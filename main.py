...
class MiApp(QtWidgets.QMainWindow):
	...
	def seleccion1(self):
		...
		if valor1=="Negro":
			...
			self.ui.label1.setStyleSheet("background-color: rgb(139, 0, 0)")
			self.valor1 = 2
		elif valor1 =="Naranja":
			...
			self.ui.label1.setStyleSheet("background-color: rgb(0, 143, 57)")
			self.valor1 = 5
		elif valor1 =="Azul":
	...
	def seleccion2(self):
		...
		if valor2=="Negro":
			...
			self.ui.label2.setStyleSheet("background-color: rgb(139, 0, 0)")
			self.valor2 = 2
		elif valor2 =="Naranja":
			...
			self.ui.label2.setStyleSheet("background-color: rgb(0, 143, 57)")
			self.valor2 = 5
		elif valor2 =="Azul":
	...
	def seleccion3(self):
		...
		if valor3=="Plata":
			...
			self.ui.label3.setStyleSheet("background-color: rgb(139, 0, 0)")
			self.valor3 = 100
		elif valor3 =="Naranja":
			...
			self.ui.label3.setStyleSheet("background-color: rgb(0, 143, 57)")
			self.valor3 = 100000
		elif valor3 =="Azul":
	...
	def seleccion4(self):
		...
		if valor4=="Ninguna":
			...
			self.ui.label4.setStyleSheet("background-color: rgb(139, 0, 0)")
			self.valor4 = 0.02
			self.Tol = "2%"
